let
    # Import the overall nixpkgs listing and our MpiVectorAdd derivation
    pkgs = import <nixpkgs> {};
    MpiVectorAdd = pkgs.callPackage ./MpiVectorAdd {};
    ...
    mpirunArguments = let
        ...
        process = "${MpiVectorAdd}/bin/MpiVectorAdd";  # The process that will be distributed
...
in pkgs.nixosTest ({
    name = "MpiVectorAdd_vms";  # The name of the test, doesn't really matter.
